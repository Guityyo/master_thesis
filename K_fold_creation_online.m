%% Divides dataset into K folders and then each folder into train and test
%  Proportion 1 folder test the rest train (5:4/1->20% 10:9/1->10%)
%       colms - num of instances
%       K     - num of folders


function [finalTRAIN,finalTEST]= K_fold_creation_online(colms,K) 
